                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className="sr-only">
                      How to request a new workflow
                    </span>
                  </Badge>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs text-left">
                  Please select the team you would like to request a new
                  workflow for, followed by a description of the workflow.
                  Please include which tools the workflow will interact with.
                  After review, a member of the Jenjco team will be in touch with your team.
                </TooltipContent>
              </Tooltip>
            </div>
          </DialogHeader>
